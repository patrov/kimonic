...
var JsonRepository = function(repositoryName,callbacks){
    ...
    this.init = function(repositoryName){
        ...
        var repositoryName = (repositoryName.match(repoMatch)) ? repositoryName :repositoryName+"Repository";
    ...
    this.createOrRetrieveDb = function(){
        var data = {};
        if(data = localStorage.getItem(this.repositoryname)){
...
var jsonadapter = {
    ...
    create : function(model){
        if(model.uid){ this.update(model); return;}
